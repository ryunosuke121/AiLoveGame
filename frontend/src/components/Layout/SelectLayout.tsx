import { ReactElement, useState, useEffect, Dispatch, SetStateAction, ReactNode } from "react"
  ...
  return (
    <>
      <div className="bg-custom-pink text-custom-pink h-screen w-screen ">
        <div className="text-4xl text-center p-4">理想の人を作ってみよう！</div>
        <div className="text-xl text-center">
          {message === 0 ? "まずは見た目から！" : "次は性格を決めよう！"}
        </div>
        <div className="text-xl text-center">どれか一つを選択してね</div>
        <div className="text-xl p-6">{currentQuestion.question}</div>
